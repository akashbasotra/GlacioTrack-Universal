...
with st.sidebar:
    ...
    pixel_size = st.number_input("Pixel Size (m)", min_value=10.0, max_value=100.0, value=30.0)
    time_interval = st.number_input("Time Interval (days)", min_value=1, max_value=365, value=12)
